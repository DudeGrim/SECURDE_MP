              ...
              <div class="panel-heading">Register</div>
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('middleInitial') ? ' has-error' : ''); ?>">
                            <label for="middleInitial" class="col-md-4 control-label">Middle Initial</label>

                            <div class="col-md-6">
                                <input id="middleInitial" type="text" class="form-control" name="middleInitial" value="<?php echo e(old('middleInitial')); ?>">

                                <?php if($errors->has('middleInitial')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('middleInitial')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
